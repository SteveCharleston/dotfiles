...
nmap <leader>ot :Obsidian today<cr>
nmap <leader>oy :Obsidian yesterday<cr>
nmap <leader>om :Obsidian tomorrow<cr>
nmap <leader>on :Obsidian new<cr>
nmap <leader>os :Obsidian search<cr>
nmap <leader>oq :Obsidian quick_switch<cr>
nmap <leader>oa :Obsidian tags<cr>
nmap <leader>od :Obsidian dailies<cr>
